...
const sql_insert_new = "INSERT INTO task (name, status, start_date, finish_date, executor_surname) VALUES (?,?,?,?,?)";
...
exports.addFile = async function (id,filedata) {
...
exports.updateTask = async function (id,taskobj) {

    try {
        const toupdate = [taskobj.status, taskobj.finish_date, id];
