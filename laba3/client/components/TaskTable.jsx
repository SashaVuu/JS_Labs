                            ...
                            this.props.tasks.map(task => {
                                return (
                                    <tr>
                                        ...
                                        <td><Button variant="primary" onClick={() => this.handleDeleting(task.idtask)}>Delete</Button></td>
                                        <td><Button variant="primary" onClick={() => this.handleEditing(task.idtask)}>Edit</Button></td>
                                    </tr>
                                );
                            }
                            )}
